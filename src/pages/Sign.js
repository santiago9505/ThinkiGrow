  ...
  return (
    <div className="sign">
      <div className="sign__square">
        ...
        <form className="signup__form" onSubmit={handleSubmit} action="">
          ...
          <label className="signup__question" htmlFor="">
            ...
            <div className="signup__question--phone">
              ...
              <input
                ...
                className="signup__input--phone input"
                placeholder="Número"
                type="tel"
                required
              />
          ...
          <label className="signup__question" htmlFor="">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (e.target.value === "unirse") {
                  setCommunities(true);
                } else if (e.target.value === "crear") {
              ...
              required
            >
              <option className="signup__input input" value="">
          ...
          <label
            className={
              communities
                ? "communities__open signup__question"
                : "communities__close"
            }
            htmlFor=""
          >
            <span className="span">
              ¿De cuál comunidad quieres hacer parte?
            </span>
            <select
